...
var printPdf = document.getElementById('btn_print');
            ...
            didOpen: () => {
                $(document).ready(function () {
                    const table = $("#table_list").DataTable({
                        ...
                        order: [1, "asc"],
                        ajax: {
                            url: "FrmPrintResult/GetCustomer",
                            dataType: "json",
                            type: "GET",
                            data: {
                                _token: csrfToken
