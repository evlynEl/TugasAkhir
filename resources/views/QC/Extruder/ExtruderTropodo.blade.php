...
@section('content')
                ...
                <div class="col-md-7 RDZMobilePaddingLR0">
                    ...
                    <div class="card">
                        <div class="card-body RDZOverflow RDZMobilePaddingLR0" style="padding-left: 20px">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label style="padding: 0; text-decoration: underline;">Extruder Tropodo</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 d-flex">
                                    <label for="idKonversi" style="font-size: 11px">Id Konv.</label>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="hapusElement">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="lldpe" name="lldpe" class="form-control mb-1"
                                            readonly>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="ldpeLami" name="ldpeLami" class="form-control mb-1"
                                            readonly>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="conductive" name="conductive"
                                            class="form-control mb-1" readonly>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="hdpe" name="hdpe" class="form-control mb-1"
                                            readonly>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="sweeping" name="sweeping" class="form-control mb-1"
                                            readonly>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input style="width: 120%" type="text" id="injection" name="injection" class="form-control mb-1"
                                            readonly>
                                    </div>
                                    <div class="col-sm-4">
    ...
    <link rel="stylesheet" href="{{ asset('css/QC/Extruder/ExtruderTropodo.css') }}">
