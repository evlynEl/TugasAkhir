        ...
        <div class="row justify-content-center">
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                <div class="card" style="width:1200px;">
                    <div class="card-header" style="">Permohonan Acc Hibah</div>

                    <div class="card-body" style="">
                        <div class="BORDERB" style="">
                            <div class="row" style="margin-left:-180px;margin-top:25px;">
                                <div class="form-group col-md-3 d-flex justify-content-end">
                                    <input type="radio" id="opsi1" name="opsi">
                                    <label for="staff" style="margin-top: 5px;margin-left:10px;">ACC</label>
                                </div>
                                <div class="form-group col-md-9 mt-3 mt-md-0" >
                                    <input type="radio" id="opsi1" name="opsi">
                                    <label for="staff" style="margin-top: 5px;margin-left:10px;">Batal ACC</label>
                            ...
                            <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;margin-top:-25px">
                                    ...
                                    <div class="row" style="">
                                        <div class="form-group col-md-3 d-flex justify-content-end">
                                            <button type="button" class="btn" style="margin-left: 10px;width:100px; "
                                                ...
                                                data-target="#modalPisat">OK</button>
                            ...
                            <div class="row" style="margin-left:-180px;margin-top:-30px;">
                                <div class="form-group col-md-3 d-flex justify-content-end">
                            ...
                            <div class="row" style="margin-left:-180px;">
                                ...
                                <div class="form-group col-md-3 d-flex justify-content-end">
                                    <span class="aligned-text">Jml Barang:</span>
                                </div>
