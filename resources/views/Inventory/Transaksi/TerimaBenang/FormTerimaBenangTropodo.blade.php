                            ...
                            <table class="table table-striped table-bordered" id="tabel_Purchasing">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Kelompok Pemberi</th>
                                        <th scope="col">SubKlpPemberi</th>
                                        <th scope="col">Pemohon</th>
                                        <th scope="col">TglMohon</th>
                                        <th scope="col">NoTransINV</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="PENERIMA">
                            <div class="card-body" style="margin-left:;">
                                <div class="row" style="margin-left:-180px;">
                                    ...
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text">Jumlah&nbsp;Benang:</span>
                                    </div>
                                ...
                                <div class="row" style="margin-left:-180px;">
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text"> Alasan&nbsp;Transfer:</span>
                                    </div>
                                    <div class="form-group col-md-9 mt-3 mt-md-0">
                            ...
                            <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;margin-left:20px;margin-top:-45px;">
                                <div class="card-body" style="flex: 0 0 50%; max-width: 50%;">
                                    {{-- <div class="row" style="">
                                        <div class="form-group col-md-3 d-flex justify-content-end">
                                            <input type="radio" id="opsiKerja1" name="opsiKerja" value="Harian" checked
