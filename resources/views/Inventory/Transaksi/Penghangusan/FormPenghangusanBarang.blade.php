            ...
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                <div class="card" style="width:1200px;">
                    ...
                    <div class="card-body" style="">
                        ...
                        <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;">
                            <div class="card-body" style="flex: 0 0 45%; max-width: 45%;">
                            ...
                            <div class="card-body" style="flex: 0 0 55%; max-width: 55%; border:1px solid black">
                                <div class="row" style="">
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                    ...
                                    <div class="form-group col-md-9 mt-3 mt-md-0">
                                        <input class="form-control" type="text" id="Kd_PISAT" readonly
                                            style="resize: none; height: 40px; max-width: 170px;">
                                ...
                                <div class="row" style="">
                                    ...
                                    <div class="form-group col-md-9 mt-3 mt-md-0">
                                        <input class="form-control" type="text" id="PISAT" readonly
                                            style="resize: none; height: 40px; width: 250px;">
                                        {{-- <select class="form-control" id="Nama_Div" readonly name="Nama_Div"
                                            style="resize: none; height: 40px; max-width: 250px;">
                                            <option value=""></option>
                                            @foreach ($divisi as $data)
                                ...
                                <div class="row" style="margin-left:;">
                                    ...
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text">Stok&nbsp;Akhir:</span>
                                    </div>
                                    <div class="form-group col-md-3 d-flex " style="margin-left: ;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 70px;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 40px;">
                                    </div>
                                    <div class="form-group col-md-3 d-flex " style="margin-left: ;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 70px;">
                                ...
                                <div class="row" style="margin-left:;">
                                    ...
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text">Dihanguskan:</span>
                                    </div>
                                    <div class="form-group col-md-3 d-flex " style="margin-left: ;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 110px;">
                                    </div>
                                    <div class="form-group col-md-3 d-flex " style="margin-left: ;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 110px;">
                        ...
                        <div style="text-align: right; margin: 10px;">
                            ...
                            <button type="button" class="btn " style="width: 75px" id="buttonIsi">Isi</button>
                            <button type="button" class="btn " style="width: 75px"
                                id="buttonKoreksi">Koreksi</button>
                            <button type="button" class="btn " style="width: 75px" id="buttonHapus">Hapus</button>
