        ...
        <div class="row justify-content-center">
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                <div class="card" style="width:1200px;">
                    <div class="card-header" style="">Acc Penyesuaian Barang</div>
                    ...
                    <div class="card-body" style="">
                                ...
                                <div class="card-body" style="flex: 0 0 50%; max-width: 50%;">
                                    <div class="row" style="">
                                        ...
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            ...
                                            <span class="aligned-text" style="margin-left:10px;">Penyetuju:</span>
                            ...
                            <div class="card-body" style="margin-left:;">
                                <div class="row" style="margin-left:-150px;">
                                    ...
                                    <div class="form-group col-md-9 mt-3 mt-md-0">
                                        ...
                                        <span class="aligned-text" style="margin-left:12px;"> Tanggal&nbsp;Transaksi:</span>
                                        <input class="form-control" type="text" id="Kawin" readonly
                                            style="resize: none; height: 40px; max-width: 180px;">
                                        <span class="aligned-text" style="margin-left:12px;"> Pemohon:</span>
                                        <input class="form-control" type="text" id="Kawin" readonly
                                            style="resize: none; height: 40px; max-width: 180px;">
                                ...
                                <div class="row" style="margin-left:-150px;">
                                    ...
                                    <div class="form-group col-md-9 mt-3 mt-md-0">
                                        <input class="form-control" type="text" id="Kawin" readonly
                                            style="resize: none; height: 40px; max-width: 180px;">
                                        <input class="form-control" type="text" id="Kawin" readonly
                                            style="resize: none; height: 40px; max-width: 674px;">
                                ...
                                <div class="row" style="margin-left:-150px;">
                                    ...
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text">Sebelum&nbsp;Disesuaikan:</span>
                                    </div>
                                ...
                                <div class="row" style="margin-left:-150px;">
                                    ...
                                    <div class="form-group col-md-3 d-flex justify-content-end">
                                        <span class="aligned-text">Sesudah&nbsp;Disesuaikan:</span>
                                    </div>
                                    <div class="form-group col-md-3 d-flex " style="margin-left: ;">
                                        <input class="form-control" type="text" id="Nama_Posisi" disabled
                                            style="resize: none; height: 40px; width: 130px;" placeholder="0">
                        ...
                        <div style="text-align: right; margin: 10px;">
                            ...
                            <button type="button" class="btn " style="width: 95px" id="buttonProses">Proses</button>
