                ...
                <div class="card">
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        ...
                        <div id="baris-2">
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <label><strong>Stok Akhir</strong></label><div class="col-sm-1"></div>
                                    <label>Primer</label>
                                    <div class="col-sm-3">
