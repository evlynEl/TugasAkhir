                ...
                <div class="card" style="width:1200px;">
                    ...
                    <div class="card-body" style="">
                        ...
                        <div class="PENERIMA" style="">
                            ...
                            <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;margin-top:-50px;">
                                <div class="card-body" style="flex: 0 0 100%; max-width: 100%;">
                                    ...
                                    <div class="row" style="margin-left:-200px;">
                                        ...
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            ...
                                            <input class="form-control" type="text" id="Nama_Posisi" disabled
                                                style="resize: none; height: 40px; max-width: 1000px;">
                                            {{-- <select class="form-control" id="Nama_Div" readonly name="Nama_Div"
                                                style="resize: none; height: 40px; max-width: 250px;">
                                                <option value=""></option>
                                                @foreach ($divisi as $data)
                                ...
                                <div style="text-align: right; margin: 10px;">
                                    ...
                                    <button type="button" class="btn btn" style="width: 75px" id="buttonIsi">Isi</button>
                                    <button type="button" class="btn btn" style="width: 75px" id="buttonKoreksi">Koreksi</button>
                                    <button type="button" class="btn btn" style="width: 75px" id="buttonHapus">Hapus</button>
                                    <button type="button" class="btn btn" style="width: 75px" id="buttonProses" disabled>Proses</button>
                                    <button type="button" class="btn btn" style="width: 75px" id="buttonBatal" disabled>Batal</button>
                                </div>
