        ...
        <div class="row justify-content-center">
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                <div class="card" style="width:1200px;">
                    <div class="card-header" style="">Acc Permohonan Pemberi Barang Antar Divisi (Awal Penerima Barang)
                    </div>

                    <div class="card-body" style="">
                        <div class="PEMBERI" style="">
                            ...
                            <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;">
                                <div class="card-body" style="flex: 0 0 50%; max-width: 50%;">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            <input type="radio" id="opsi1" name="opsi">
                                            <label for="staff" style="margin-top: 5px;margin-left:10px;">Batal
                                                ACC</label>
                                ...
                                <div class="card-body" style="flex: 0 0 50%; max-width: 50%;margin-top:-4px;">
                                    <div class="row" style="">
                                        <div class="form-group col-md-3 d-flex justify-content-end">
                        ...
                        <div style="text-align: right; margin-top: 20px;">
                            <button type="button" class="btn " id="TambahButton" disabled>PROSES</button>
