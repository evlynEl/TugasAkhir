        ...
        <div class="row justify-content-center">
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                <div class="card" style="width:1200px;">
                    <div class="card-header" style="">Permohonan Pemberi Barang Antar Divisi (Awal Penerima Barang)
                    </div>
                    ...
                    <div class="card-body" style="">
                        <div class="PEMBERI" style="">
                            ...
                            <div class="card-body-container" style="display: flex; flex-wrap: wrap; margin: 10px;">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            <input class="form-control" type="text" id="Kd_PISAT" readonly
                                                style="resize: none; height: 40px; max-width: 100px;">
                                                <span class="aligned-text" style="margin-left:20px;">Kode&nbsp;Barang:</span>
                                                <input class="form-control" type="text" id="Kd_PISAT" readonly
                                                style="resize: none; height: 40px; max-width: 100px;">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body" style="flex: 0 0 50%; max-width: 50%;margin-top:;">
                                    <div class="row" style="">
                                        <div class="form-group col-md-3 d-flex justify-content-end">
                                            <span class="aligned-text">User Pemberi:</span>
                                        </div>
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            <input class="form-control" type="text" id="Kd_PISAT" readonly
                                                style="resize: none; height: 40px; max-width: 100px;">
